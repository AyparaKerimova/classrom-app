    ...
    <div className="relative h-screen bg-gray-50 overflow-hidden">
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          >
            <path
              d="M61 7V41H3V7C3.00158 6.47005 3.2128 5.96227 3.58753 5.58753C3.96227 5.2128 4.47005 5.00158 5 5H59C59.5299 5.00158 60.0377 5.2128 60.4125 5.58753C60.7872 5.96227 60.9984 6.47005 61 7V7Z"
              fill="#026EAA"
            ></path>
            <path
              d="M49.96 5L13.96 41H3V7C3.00158 6.47005 3.2128 5.96227 3.58753 5.58753C3.96227 5.2128 4.47005 5.00158 5 5H49.96Z"
              fill="#0C84C1"
            ></path>
            ...
            ></path>
            <path
              d="M3 41H61V45C61 45.5304 60.7893 46.0391 60.4142 46.4142C60.0391 46.7893 59.5304 47 59 47H5C4.46957 47 3.96086 46.7893 3.58579 46.4142C3.21071 46.0391 3 45.5304 3 45V41Z"
              fill="#CCCCCC"
            ></path>
            <path
              d="M31 44H33"
