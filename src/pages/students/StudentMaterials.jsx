  ...
  return (
    <div className="relative w-full flex flex-wrap min-h-screen bg-gray-50 py-6 sm:py-12">
      {data && data.map((material) => ( 
        <div key={material.id} style={{ maxHeight: '350px' }}  className="group relative  cursor-pointer overflow-hidden bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-4 sm:max-w-sm sm:rounded-lg sm:px-10 ">
